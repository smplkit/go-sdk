...
// LimitListResponse defines model for LimitListResponse.
type LimitListResponse struct {
	Data []LimitResource `json:"data"`
}

// LimitResource defines model for LimitResource.
type LimitResource struct {
	Attributes Limit   `json:"attributes"`
	Id         *string `json:"id,omitempty"`
	Type       string  `json:"type"`
}
...
type ListLimitsResponse struct {
	Body                     []byte
	HTTPResponse             *http.Response
	ApplicationvndApiJSON200 *LimitListResponse
	ApplicationvndApiJSON400 *ErrorResponse
	ApplicationvndApiJSON401 *ErrorResponse
	ApplicationvndApiJSON404 *ErrorResponse
	ApplicationvndApiJSON429 *ErrorResponse
